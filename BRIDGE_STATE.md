...
| Factory OS surfaces | Home **live loopback** + **next-best-action** (42) · Discover **shells** (39) · Evidence & Receipts **ledger** (40) · Integrations **shell** (41) · FLOW-01/02 **deepened** + universal records (**28**, **35**) · FLOW-03 **DONE** (thin) · FLOW-04 **thin RO in progress** · Portfolio+Work **in progress** · Teams **DONE** · **durable Factory DB** · **Decision Inbox V2** (auth-gated approve) · **Operate RO** · conversation bar **RO** · **auth stub** |
